...
# ***Layout of Git-Repo***
1. #### We have a folder called Weekly Reports to store the weekly updates due every Wednesday.
2. #### We have two folders called App and Idea which are the files containing our code to the phone app we have up and running at the moment.
